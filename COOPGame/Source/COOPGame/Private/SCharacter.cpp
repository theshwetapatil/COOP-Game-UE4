...
void ASCharacter::Tick(float DeltaTime)
{
	...
	float TargettFOV = bWantsToZoom ? ZoomedFOV : DefaultFOV;

	float CurrentFOV = FMath::FInterpTo(CameraComp->FieldOfView, TargettFOV, DeltaTime, ZoomInterSpeed);
...
bool ASCharacter::GetPlayerDeathState()
{
	return bDied;
}
